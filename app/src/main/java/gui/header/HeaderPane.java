...
public class HeaderPane extends JPanel {
    ...
    public HeaderPane(NavigationController navigationController, UserController userController, boolean showButtons, String title) {
        super();
        ...
        try {
            ...
            logoutButton.addActionListener(e -> {
                if (JOptionPane.showConfirmDialog(null, "Are you sure you want to logout?", "Message",
                        JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) navigationController.logout();
            });
